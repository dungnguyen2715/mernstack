...
dotenv.config()
const uri = `mongodb+srv://${process.env.DB_USERNAME}:${process.env.DB_PASSWORD}@mernstackclut.wnoqo.mongodb.net/?retryWrites=true&w=majority&appName=mernstackClut`

// Create a MongoClient with a MongoClientOptions object to set the Stable API version
class DatabaseService {
  private client: MongoClient
  private db: Db //tạo thành thuộc tính db
  constructor() {
